...
app.create(app.store, {
  ...
  onLoad: function (options) {
    this.setData({
      imgWidth: (this.store.data.device.windowWidth - 21) / 2,
    });
  ...
  //   }).then(() => {
  //     app
  //       .getApi('/at/delete', { id: this.data.anchors.data[index].id })
  //       .then((res) => {
  //         wx.showToast({
  //           title: '删除成功',
  //         });
